...
| `simple-work` | Simple work | `deepseek-v4-flash` (max) -> `gpt-5.6-luna-fast` (low) -> `claude-haiku-4-5` |
| `deep-work` | Deep work | `deepseek-v4-flash` (max) -> `gpt-6-astra` (high) -> `gpt-5.6-sol` (medium), the `deep` category chain verbatim |
